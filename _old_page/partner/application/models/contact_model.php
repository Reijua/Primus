...
class Contact_Model extends CI_Model {
    ...
    function get_privilege($p_group_id, $p_type_name){
        ...
        $query = $db_default->query("SELECT * FROM Model INNER JOIN ModelPrivilege USING(model_id) INNER JOIN ModelPrivilegeType USING(type_id) WHERE group_id = ? AND UPPER(type_name) = UPPER(?) AND LOWER(model_name) = LOWER('Contact_Model')", array($p_group_id, $p_type_name));
        return $query;
    }
