<?php if($this->input->cookie("partner_id") == 'DUKOMMSTNETREIN'){ ?>
<link rel="stylesheet" href="http://partner.primus-romulus.net/resource/css/owl.carousel.css">
<script src="http://partner.primus-romulus.net/resource/js/owl.carousel.js"></script>
<script>
...
<div class="banner">
	...
	<div class="banner-content">
		...
		echo '
						<div class="item logo-item"><img src="'.$this->Account_Model->get_logo($cdn_url, $row->company_id).'" alt="'.$row->company_name.'" /></div>
			  ';	  
