					...
					<table style="width:100%; border-collapse:0; border-spacing:0; margin: 20px 0;  font-family:'Open Sans', Arial, sans-serif; font-weight: 300;">
						<tr>
							<td>
								...
								<br />
								Damit Sie Das Passwort zurücksetzen können, öffne Sie bitten den folgenden Link in Ihrem Browser.<br />
								<br />
								<a href="http://partner.primus-romulus.net/support/recovery/?code=<?php echo $object_code; ?>&email=<?php echo $object_account->member_email; ?>"  style="color: #0099CC; text-decoration:none;">http://partner.primus-romulus.net/support/recovery/?code=<?php echo $object_code; ?>&amp;email=<?php echo $object_account->member_email; ?></a><br />
								<br />
								Sollten Sie sich nach der Eingabe des neuen Passwortes noch immer nicht anmelden können, wende Sie sich bitte per E-Mail an <a href="mailto:support@primus-romulus.net" style="color: #0099CC; text-decoration:none;">support@primus-romulus.net</a>.<br />
								<br />
