...
class Application extends CI_Controller {
	...
	public function get_content($category_name = "", $application_id = ""){
		if($this->session->userdata('login')){
			...
			if($this->Application_Model->get_application($data["object_account"]->group_id, $category_name, $application_id)->num_rows()==1){
				...
				$v_application = $this->Application_Model->get_application($data["object_account"]->group_id, $category_name, $application_id)->row();
