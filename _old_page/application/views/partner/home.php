<div class="banner" style="background-image: url(<?=$this->P_account_model->get_banner($cdn_url, $object_account->company_id) ?>)">
	<table class="partner-logo">
		<tr>
			<td><img src="<?=$this->P_account_model->get_logo($cdn_url, $object_account->company_id) ?>"></td>
		</tr>
	</table>
</div>
<div class="container light-grey">
	<div class="nav-holder">
		<nav>
			<ul>
				<?php
				foreach ($this->P_application_model->get_application($object_account->group_id, "menu")->result() as $row) {
