...
<title>Primus Romulus Account aktiviert.</title>
...
<body style="font-family: 'Open Sans', 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.42857; color: #333; background-image: url('http://www.primus-romulus.net/assets/images/layout/background/clean_paper_light.png'); background-attachment: scroll; background-repeat: repeat; background-color: #f2f2f2; background-position: 0% 0%; padding: 30px;" bgcolor="#f2f2f2">
	...
	<div style="width: 640px; border-radius: 10px; background-color: #fff; margin: 0 auto; padding: 0 15px 15px; border: 1px solid #ddd; box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.05);">
		...
		<div style="padding: 0 10px 10px;">
			...
			<span style="color: #3b5999; font-size: 18px; font-weight: 600; margin-bottom: 20px;">Aktivierung deines Primus Romulus Accounts</span><br><br>

			{salutation}<br><br>

			Vielen Dank, dass du dich bei <a href="<?= base_url() ?>" style="text-decoration: none; color: #3b5999;">Primus Romulus</a> registriert hast!<br><br>

			Wir haben deine Accountdaten überprüft und dich freigeschaltet! Du kannst nun alle Funktionen der Plattform nutzen und dich mit deiner E-Mail-Adresse und deinem Passwort auf  <a href="<?= base_url()?>member/login" style="text-decoration: none; color: #3b5999;">http://www.primus-romulus.net/member/login</a> anmelden.<br><br> 

			Falls du noch Fragen hast oder Probleme auftreten, schreibe einfach eine Mail an <a href="mailto:office@primus-romulus.net">office@primus-romulus.net</a>. <br><br><br>

			Mit freundlichen Grüßen<br><br>

			Dein Team von Primus Romulus
