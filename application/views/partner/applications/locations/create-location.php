			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="fax" name="fax" placeholder="Faxnummer" value="<?= set_value('fax') ?>">
						<?= form_error('fax'); ?>
					</div>
					<div class="form-group">
						<label for="email">E-Mail</label>
						<input type="text" class="form-control" id="email" name="email" placeholder="E-Mail-Addresse" value="<?= set_value('email') ?>">
						<?= form_error('email'); ?>
					</div>
					<div class="form-group">
						<label for="website">Webseite</label>
						<input type="text" class="form-control" id="website" name="website" placeholder="Webseite, URL" value="<?= set_value('website') ?>">
						<?= form_error('website'); ?>
					</div>
				</div>
			</div>
...
$(document).ready(function() {
	...
	function saveLocation() {
		...
		$.ajax({
			type: 'POST',
			url: '/partner/locations/create-location',
			data: data,
			contentType: false,
			processData: false,
